...
-- (hero, universos, vitrines de produto, faixa de marca, história 45+,
-- coleções, manifesto/consultora e encerramento). Depois disso, a "/" passa a ser editável
...
(@pid, 'newsletter', 'Encerramento: canais da marca', 9, '{}', 1);
